...
-- Vote_User [rel13]
alter table "vote"  add column  "user_id"  int4;
alter table "vote"   add constraint fk_vote_user foreign key ("user_id") references "user" ("id");
create index "idx_vote_user" on "vote"("user_id");


-- User_Exhibition [rel14]
alter table "user"  add column  "exhibition"  int4;
alter table "user"   add constraint fk_user_exhibition foreign key ("exhibition") references "exhibition" ("id");
create index "idx_user_exhibition" on "user"("exhibition");


-- Vote_Exhibition [rel15]
alter table "vote"  add column  "exhibition_id"  int4;
alter table "vote"   add constraint fk_vote_exhibition foreign key ("exhibition_id") references "exhibition" ("id");
create index "idx_vote_exhibition" on "vote"("exhibition_id");
